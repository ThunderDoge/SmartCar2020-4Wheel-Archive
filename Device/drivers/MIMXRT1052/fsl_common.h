...
#define AT_OTCRAM_SECTION(func) func @"OTCRAMAccess"
#define AT_SDRAM_SECTION(func)  func @"SDRAMAccess"
...
#define AT_OTCRAM_SECTION(func) __attribute__((section("OTCRAMAccess"))) func
