...
#define SERVO_INTERVAL_PWM_VAL 120 //120
#define SERVO_MID_PWM_VAL (Ui_Servo_Mid_Pwm)
#define SERVO_LEFT_PWM_VAL (Ui_Servo_Mid_Pwm - SERVO_INTERVAL_PWM_VAL)
#define SERVO_RIGHT_PWM_VAL (Ui_Servo_Mid_Pwm + SERVO_INTERVAL_PWM_VAL)

#define ADC_INTERVAL_PWM_VAL 120 //120
...
#define PWM1_MODULE3_PWMA             L5//已用作电机      //  A11 D6  G13  H1  L5      H1 D6接外部SDRAM
#define PWM1_MODULE3_PWMB             M5//已用作电机      //  A6  B7  B11  G10 M5      A6 B7接外部SDRAM
...
#define PWM2_MODULE3_PWMA             M3//已用作电机      //  B4  C11  F14 M3  M14     B4 接外部SDRAM  F14 JTAG TDI接口
#define PWM2_MODULE3_PWMB             M4//已用作电机      //  A3  D11  H10 M4          A3 接外部SDRAM
...
extern void MotoInit(void);//舵机
extern void ServoInit(void);//电机
...
/**
  ...
  * @date     2019/5/23 星期四
  */
extern inline void LQ_SetServoDty(uint16_t duty);
...
/**
  ...
  * @date     2019/5/23 星期四
  */
extern void LQ_PWMA_B_SetDuty(PWM_Type *base, pwm_submodule_t subModule, uint16_t dutyA, uint16_t dutyB);
...
/**
  ...
  * @date     2019/5/23 星期四
  */
extern void LQ_PWM_InitPins(PWM_Type *base, pwm_submodule_t subModule, pwm_channels_t pwm_channels);
...
/**
  ...
  * @date     2019/5/23 星期四
  */
extern void PWM_UpdateDuty(PWM_Type *base,
