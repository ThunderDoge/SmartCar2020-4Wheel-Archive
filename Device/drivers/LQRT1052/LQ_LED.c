...
{    
    ...
    GPIO_PinInit(GPIO2,24, &GPIO_Output_Config);     //A12   蜂鸣器
    
        IOMUXC_SetPinMux(IOMUXC_GPIO_B0_06_GPIO2_IO06, 0U);//A8
        IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_06_GPIO2_IO06,0x10B0u);
        GPIO_PinInit(GPIO2,06, &GPIO_Output_Config);
