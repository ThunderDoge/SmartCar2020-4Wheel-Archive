...
/**********************************  ENC(引脚复用) *******************************************************/
//     ENC输入通道        端口    可选范围                       建议
#define ENC1_PHASE_A       C10      //XBARA
#define ENC1_PHASE_B       D10      //XBARA
...
/**
  ...
  * @date     2019/6/12 星期三
  */
extern void LQ_ENC_Init(ENC_Type *base,bool direction);
...
extern void EncoderWork(void);
extern int16_t getEncoderValueLeft(void);
extern int16_t getEncoderValueRight(void);
/**
  * @brief    初始化 ENC管脚
  *
  * @param    base        ： ENC1 - ENC4
