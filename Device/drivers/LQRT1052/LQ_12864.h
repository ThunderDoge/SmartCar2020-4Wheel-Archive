...
extern char * getOledBuf(unsigned char y);
extern void LCD_refreshOneLine(unsigned char y, bool showReversely);
extern void LCD_refreshHalfLine(unsigned char y, bool showReversely);
void oledPutOnePos(unsigned char x,unsigned char y, unsigned char data);
